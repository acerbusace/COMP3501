...
float speed = 1.25; // Allows to control the speed of the explosion
...
void main()
{
    ...
    position.x += 1.2 + norm.x*t*speed - grav*speed*up_vec.x*t*t;
    position.y += 1.2 + norm.y*t*speed - grav*speed*up_vec.y*t*t;
